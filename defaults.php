...
$passwordError = "Hint: Password must have minimum 8 charactors. It must contain 1 Uppercase charactor and 1 Number.";
...
$criteriaErrors = ["name" => "*Please enter a valid Name!", "email" => "*Please enter a valid Email Address!", "mobile-num" => "*Please enter a valid Mobile Number!", "password" => "*Password must have minimum 8 charactors. It must contain 1 Uppercase charactor and 1 Number.", "confirm-pass" => "*Password entered here should match the above Password."];
